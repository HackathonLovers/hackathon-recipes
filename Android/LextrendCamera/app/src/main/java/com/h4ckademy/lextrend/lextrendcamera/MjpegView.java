...
public class MjpegView extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public void init(Context context) {
        Log.wtf( "wtf", "init@MpegView" );
        SurfaceHolder holder = getHolder();
        holder.addCallback(this);
        thread = new MjpegViewThread(holder, context);
        Log.wtf("MjpegView", "Init new Thread");
        setFocusable(true);
    ...
    public void startPlayback() {
        if(mIn != null) {
            mRun = true;
            Log.wtf("MjpegView", "startPlayback");
            thread.start();
        }
    }
    ...
    public void stopPlayback() {
        ...
        while(retry) {
            try {
                thread.interrupt();
                init(getContext());
                Log.wtf("MjpewView", "stopPlayback  stop thread");
                retry = false;
            } catch (Exception e) {
                e.getStackTrace();
    ...
    public Bitmap takeScreenshotImage() {
